<?php
//Definitions
  define('_DATABASE', 'db_wordpress');
  define('_CURRENT_SITE_DOMAIN', 'localhost:3000');
...
// https://raw.githubusercontent.com/ren4ndev/developer-guide/main/helpers/wp-config.php
